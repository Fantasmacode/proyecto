...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('administrador') }}" style="background-color:#3D5F15;">
                <div class="fa fa-fw fa-home">
                </div>
                <div class="sidebar-brand-text mx-3" >Menu Gerente<sup></sup></div>
            </a>
    

            <!-- Nav Item - Dashboard -->
            <li class="nav-item active" style="background-color:#3D5F15;">
            ...
            <!-- Nav Item - Dashboard -->
             <li class="nav-item active" style="background-color:#3D5F15;">
                <a class="nav-link" href="{{  route('ganadousuario') }}">
           ...
           <li class="nav-item active" style="background-color:#3D5F15;">
                <a class="nav-link" href="{{ route('userubicacion') }}">
          ...
          <hr class="sidebar-divider my-0">
            ...
            <div class="text-center d-none d-md-inline">
                <button class="rounded-circle border-0" style="background-color:#3D5F15;" id="sidebarToggle"></button>
            </div>
