...
<input type="password" class="form-control {{ $errors-> has('password')?'is-invalid':''}}" name="password" id="password" value="{{ isset ($admin->password)?$admin->password:old('password') }}">
